...
namespace DBModule3
{
    public partial class TourOperatorBookings : UserControl
    {
        ...
        public TourOperatorBookings(int userId)
        {
            InitializeComponent();
            this.userId = userId;
            LoadTourOperatorBookings();
        }

        private void LoadTourOperatorBookings()
        {
            try
            {
                using (SqlConnection connection = DatabaseHelper.CreateConnection())
                {
                    ...
                    string query = @"SELECT b.booking_id, t.trip_name, tr.first_name + ' ' + tr.last_name as traveler_name,
                                    b.booking_date, b.status, b.total_amount, b.is_cancelled,
                    ...
                    using (SqlCommand cmd = new SqlCommand(query, connection))
                    {
                        ...
                        dataTable.Columns["traveler_name"].ColumnName = "Traveler";
        ...
        private void InitializeComponent()
        {
            ...
            this.bookingsDataGridView.Location = new System.Drawing.Point(0, 0);
            this.bookingsDataGridView.Name = "bookingsDataGridView";
            this.bookingsDataGridView.ReadOnly = true;
            this.bookingsDataGridView.Size = new System.Drawing.Size(800, 450);
